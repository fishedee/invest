...
files = [
	...
	['../data/china_index/上证50全收益_交易特征_时间序列分析.xls','../data/china_index/沪深300价值全收益_交易特征_时间序列分析.xls'],
	['../data/china_index/上证50全收益_交易特征_时间序列分析.xls','../data/china_index/沪深300成长全收益_交易特征_时间序列分析.xls'],
